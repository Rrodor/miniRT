...
/*   Updated: 2023/08/23 16:37:39 by aramon           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_pos   *get_pixel_center(int x, int y)
{
    ...
    t_vec   *viewport_upper_left_corner = vec_sub(vec_sub(vec_sub_pos(camera_center, focal_length), vec_div(viewport_u, 2)), vec_div(viewport_v, 2));
    t_pos   *pixel_00_pos = vec_add_pos(viewport_upper_left_corner, vec_mult_num(vec_add(pixel_delta_u, pixel_delta_v), 0.5));
